...
public class ArraysEx1 {
	public static void main(String[] args) {
		...
		char[] arr2 = arr1;	//arr1의 내용이 아니라 arr2의 주소를 복제
		...
		char[] arr4 = Arrays.copyOfRange(arr3, 0, 4);
		System.out.println(arr4);
		System.out.println("얕은 복제의 비교1 : "+Arrays.equals(arr1, arr2));
		System.out.println("깊은 복제의 비교1 : "+Arrays.equals(arr1, arr3));
		//System.out.println("깊은 복제의 비교2 : "+Arrays.deepEquals(arr1, arr2));		-	2차원 배열일 경우 가능
		//System.out.println("깊은 복제의 비교2 : "+Arrays.deepEquals(arr1, arr3));		-	2차원 배열일 경우 가능
